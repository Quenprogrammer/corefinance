...
@Component({
  ...
  styleUrl: '../../incomeAccount/idashboard/idashboard.scss',
})
export class Sdashboard {
  ...
  menu=[
    {icon:"cashbook/1.png", name:"Add Transaction", link:"/sAddTRANSACTION"},

    {icon:"cashbook/3.png", name:"Payment Categories", link:"/sPayment-Transactions"},
    {icon:"cashbook/6.png", name:"Receipt Categories", link:"/sReceipt-Transactions"},
    {icon:"cashbook/11.png", name:"Transactions",link:"/sTRANSACTIONs" },
    {icon:"cashbook/14.svg", name:"Monthly Analysis", link:"/sMonthlyAnalysis"},
    {icon:"cashbook/8.png", name:"Payment Transactions", link:"/sPayment-Transactions"},
    {icon:"cashbook/9.png", name:"Receipt Transactions", link:"/sReceipt-Transactions"},
