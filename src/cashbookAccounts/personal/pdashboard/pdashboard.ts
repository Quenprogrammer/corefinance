...
export class Pdashboard {
  ...
  menu=[
    {icon:"cashbook/1.png", name:"Add Transaction", link:"/pAddTRANSACTION"},

    {icon:"cashbook/3.png", name:"Payment Categories", link:"/pPayment-Transactions"},
    {icon:"cashbook/6.png", name:"Receipt Categories", link:"/pReceipt-Transactions"},
    {icon:"cashbook/11.png", name:"Transactions",link:"/pTRANSACTIONs" },
    {icon:"cashbook/14.svg", name:"Monthly Analysis", link:"/eMonthlyAnalysis"},
    {icon:"cashbook/8.png", name:"Payment Transactions", link:"/pPayment-Transactions"},
    {icon:"cashbook/9.png", name:"Receipt Transactions", link:"/pReceipt-Transactions"},
