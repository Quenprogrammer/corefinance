...
@Component({
  ...
  template: `
    ...
    <div class="analysis-card receipt-card">
      <div class="card-header-modern">
        <div class="header-content">
          ...
          <div class="header-text">
            <h5 class="card-title">Receipt Analysis by Category</h5>
            <p class="card-subtitle">Income sources analysis</p>
          </div>
          <div class="header-stats" *ngIf="receiptAnalysis().length > 0">
            <div class="stat-chip">
              <i class="bi bi-pie-chart"></i>
              <span>{{ receiptAnalysis().length }} Categories</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- Statistics Cards -->
      <div class="stats-cards" *ngIf="receiptAnalysis().length > 0">
        <div class="stat-card-item">
          ...
          <div class="stat-info">
            ...
            <span class="stat-value">₦{{ getTotalReceiptAmount() | number:'1.2-2' }}</span>
          </div>
        </div>
        ...
        <div class="stat-card-item">
          ...
          <div class="stat-info">
            ...
            <span class="stat-value">{{ getTotalReceiptCount() }}</span>
          </div>
        </div>
        ...
        <div class="stat-card-item">
          ...
          <div class="stat-info">
            ...
            <span class="stat-value">{{ getTopReceiptCategory()?.category || 'N/A' }}</span>
            <small class="stat-sub">{{ getTopReceiptCategory()?.amount | number:'1.2-2' }}</small>
          </div>
        </div>
        ...
        <div class="stat-card-item">
          ...
          <div class="stat-info">
            <span class="stat-label">Average Receipt</span>
            <span class="stat-value">₦{{ getAverageReceiptAmount() | number:'1.2-2' }}</span>
          </div>
        </div>
      </div>
      ...
      <div class="card-body-modern">
        <div class="table-wrapper">
          <table class="analysis-table">
            ...
            <tbody>
            <tr *ngFor="let item of receiptAnalysis(); let i = index" class="analysis-row"
              ...
              <td class="amount-cell">
                <div class="amount-display receipt-amount">
              ...
              <td class="percentage-cell">
                <div class="progress-container">
                  <div class="progress-bar-modern receipt-progress" [style.width.%]="item.percentage">
            ...
            <!-- Empty State -->
            <tr *ngIf="receiptAnalysis().length === 0 && !loading()">
              <td colspan="4" class="empty-state">
                <div class="empty-content">
                  <i class="bi bi-folder-x"></i>
                  <p>No data available</p>
                  <small>No receipt transactions found</small>
                </div>
              </td>
            </tr>
            ...
            <tfoot *ngIf="receiptAnalysis().length > 0">
            <tr class="footer-row">
              <td class="footer-label">Total</td>
              <td class="footer-amount">
                <strong>{{ getTotalReceiptAmount() | number:'1.2-2' }}</strong>
              </td>
              <td class="footer-percentage">100%</td>
              <td class="footer-count">
                <strong>{{ getTotalReceiptCount() }}</strong>
              </td>
            </tr>
            </tfoot>
          </table>
...
export class ErecieptLedger implements OnDestroy, OnInit{
